    ...
    return new ImageResponse(
      (
        <div style={{ width: '720px', height: '1280px', display: 'flex', flexDirection: 'column', backgroundColor: themeBg, padding: '40px', color: textColor, justifyContent: 'space-between' }}>
          {/* Header */}
          <div style={{ display: 'flex', flexDirection: 'column', height: '180px', justifyContent: 'center', textAlign: 'center' }}>
          ...
          {/* Footer - QRなしでシンプルに */}
          <div style={{ display: 'flex', width: '100%', height: '140px', alignItems: 'center', justifyContent: 'center', textAlign: 'center' }}>
