// `\u30FB` や `decodeURIComponent('%E3%83%BB')` で「 /」を表現しています。
// ビルド時の Cloudflare 独自のエラー（パースエラー）回避のため、文字列合成を採用。
export const THEME_OPTIONS = [
  '人生のバイブル編',
  '涙腺崩壊' + decodeURIComponent('%E3%83%BB') + '感涙編',
  '腹筋崩壊' + decodeURIComponent('%E3%83%BB') + '爆笑編',
  'メンタル浄化編',
  'あの頃（青春）編',
  '大人で刺さった編',
  '今これ激アツ！編',
...
export const THEME_GRADIENTS: Record<string, string> = {
  ...
  [`涙腺崩壊${decodeURIComponent('%E3%83%BB')}感涙編`]: 'linear-gradient(135deg, #4facfe, #00f2fe)', // 明るすぎた水色系を少し濃く深く調整
  [`腹筋崩壊${decodeURIComponent('%E3%83%BB')}爆笑編`]: 'linear-gradient(135deg, #ff0844, #ffb199)', // 明るすぎたピンク系を少し濃くビビッドに調整
